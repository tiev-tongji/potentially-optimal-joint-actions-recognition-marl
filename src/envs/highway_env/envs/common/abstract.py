...
from envs.highway_env.envs.common.action import action_factory, Action, DiscreteMetaAction, ActionType
from envs.highway_env.envs.common.observation import observation_factory, ObservationType
from envs.highway_env.envs.common.finite_mdp import finite_mdp
from envs.highway_env.envs.common.graphics import EnvViewer
from envs.highway_env.vehicle.behavior import IDMVehicle, LinearVehicle
...
class AbstractEnv(gym.Env):
    ...
    def __init__(self, config: dict = None, render_mode: Optional[str] = None) -> None:
        ...
        # only for intersec_env
        if "seed" in self.config:
            np.random.seed(self.config["seed"])
        else:
            np.random.seed()
        self.np_random = np.random # substitute np_random in gym.Env
