...
from envs.highway_env.envs.common.action import ActionType, DiscreteMetaAction, ContinuousAction
from envs.highway_env.road.graphics import WorldSurface, RoadGraphics
from envs.highway_env.vehicle.graphics import VehicleGraphics

if TYPE_CHECKING:
    from envs.highway_env.envs import AbstractEnv
    from envs.highway_env.envs.common.abstract import Action
...
class ObservationGraphics(object):
    ...
    def display(cls, obs, sim_surface):
        from envs.highway_env.envs.common.observation import LidarObservation
