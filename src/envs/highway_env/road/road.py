...
from envs.highway_env.road.lane import LineType, StraightLane, AbstractLane, lane_from_config
from envs.highway_env.vehicle.objects import Landmark

if TYPE_CHECKING:
    from envs.highway_env.vehicle import kinematics, objects
...
class Road(object):
    ...
    def close_vehicles_to_multiagent(self, vehicle: 'kinematics.Vehicle') -> object:
